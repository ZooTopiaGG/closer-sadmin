    ...
    <section class="flex-1">
      ...
      <section class="permission_table_content" style="margin-top: 0;">
        <el-table :data="communityRecordsList.data" style="width: 100%">
          ...
          <el-table-column prop="objectID" label="金额">
          </el-table-column>
          <el-table-column prop="create_time" label="包含税金">
          </el-table-column>
          <el-table-column prop="objectID" label="到账时间">
          </el-table-column>
          <el-table-column prop="create_time" label="说明">
          </el-table-column>
        </el-table>
      </section>
      <!-- dialog  -->
