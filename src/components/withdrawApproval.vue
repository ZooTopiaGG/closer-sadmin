    ...
    <section class="flex-1">
      <section class="permission_table_top flex flex-pack-justify">
        <section class="flex flex-align-center" style="margin-right:20px;">
          <section class="flex flex-align-center">
            <el-input v-model="columnid" placeholder="请输入用户名称" @keyup.enter.native="handleSearch">
      ...
      <section class="permission_table_content" style="margin-top: 0;">
        <el-table :data="rechargeList.data" style="width: 100%">
          <el-table-column fixed prop="communityName" label="ID">
          </el-table-column>
          <el-table-column prop="fromUserName" label="申请者昵称">
          </el-table-column>
          <el-table-column prop="applyTime" label="手机号">
          </el-table-column>
          <el-table-column prop="communityId" label="身份证号">
          </el-table-column>
          <el-table-column prop="fromUserName" label="申请金额">
          </el-table-column>
